...
#include <PowerConsole/IO/AsyncDirectoryLoader.h>
...
private:
	...
	PcIO::AsyncDirectoryLoader loader;
...
public:
	...
	/* Gets the resolved current directory. */
	std::string getResolvedCurrentDirectory() const;
	...
	void addFile(PcIO::FileInfo&& file);
	/* Adds a new file to the list. */
