...
public:
    ...
    struct Chunk
    {
        Int16* samples;     ///< Pointer to the audio samples
...
protected:
    ...
    ///
    ////////////////////////////////////////////////////////////
    void initialize(unsigned int channelCount, unsigned int sampleRate, Uint64 sampleCount);
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual bool onGetData(Chunk& data, Uint64& samplePosition) = 0;
