...
///
////////////////////////////////////////////////////////////
class SoundFileReaderFFmpeg : public SoundFileReader {
public:
...
public:
	...
	//virtual bool open(const std::string& url, Info& info);
...
private:
	...
	int m_audioStream;
	uint8_t* m_ioContextBuffer;
	size_t m_ioContextBufferSize;

	SwrContext* m_convertContext;
